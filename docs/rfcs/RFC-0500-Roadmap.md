...
首份性能结果见 [`2026-07-17 Core Runtime 性能基线`](../benchmarks/2026-07-17-core-runtime.md)。Phase 7A、最小 Discovery、本地 Monitor 和 Snapshot 已完成；下一阶段先冻结 Phase 7E Supervisor 的失败通知与恢复任务 owner。
